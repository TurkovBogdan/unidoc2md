"""Reusable custom vertical scrollbar on Canvas."""
...
class CustomScrollbar(tk.Canvas):
    """Thin vertical scrollbar with fully custom drawing.

    Works with `yscrollcommand` / `command` on `Canvas`, `Text`, `Listbox`, `Treeview`.
    """
    ...
    def configure(self, cnf=None, **kwargs):
        """Supports `command=...` like ttk scrollbar plus normal Canvas configure."""
