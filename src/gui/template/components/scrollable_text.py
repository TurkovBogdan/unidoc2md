"""Text widget with vertical scrollbar (composite)."""
...
def scrollable_text(
    ...
    *,
    ...
    """
    Create tk.Text with vertical scrollbar in parent.
    Scrollbar shows only when content does not fit.
    Packs widgets into parent; returns the Text widget.
    """
    p = PALETTE
