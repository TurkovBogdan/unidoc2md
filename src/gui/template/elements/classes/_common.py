"""Shared helpers for input classes: Entry shortcuts and theme typography."""
...
def bind_entry_shortcuts(entry: tk.Entry) -> None:
    """Ctrl+A/C/V/X by keycode so shortcuts work with any keyboard layout."""
...
def bind_text_shortcuts(text: tk.Text) -> None:
    """Ctrl+A/C/V/X by keycode for tk.Text (any keyboard layout)."""
...
def input_element_typography() -> dict[str, str | tuple[int, int]]:
    """Typography dict for custom inputs from UI_INPUTS and PALETTE."""
    ui = UI_INPUTS
    return {
