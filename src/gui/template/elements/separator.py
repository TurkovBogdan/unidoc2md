"""Элементы-разделители: горизонтальная и вертикальная линии. Настройки в UI_SEPARATOR (template/styles)."""
...
def gui_element_separator(parent: tk.Misc) -> tk.Frame:
    """
    Горизонтальная линия. Цвет, толщина и отступы сверху/снизу из UI_SEPARATOR.
    Размещать в grid/pack со sticky=tk.EW.
    """
    p = PALETTE
    s = UI_SEPARATOR
...
def gui_element_separator_vert(parent: tk.Misc) -> tk.Frame:
    """
    Вертикальная линия. Цвет, толщина и отступы слева/справа из UI_SEPARATOR.
    Возвращает контейнер (линия внутри с padding_vertical_px). Размещать в grid с sticky=tk.NS.
    """
    p = PALETTE
    s = UI_SEPARATOR
