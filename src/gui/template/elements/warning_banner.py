"""Элемент «Предупреждение»: плашка с текстом и вертикальной линией слева."""
...
def gui_element_warning_banner(parent: tk.Misc, text: str) -> tk.Frame:
    """
    Плашка предупреждения: вертикальная линия слева (цвет primary), справа — текст.
    Возвращает контейнер для размещения в grid/pack.
    """
    p = PALETTE
