"""Input widget styles: TEntry, TCombobox, TCheckbutton, TRadiobutton, TSpinbox."""
...
def gui_setup_input_styles(
    ...
    """
    Styles for TEntry, TCombobox, TCheckbutton, TRadiobutton, TSpinbox.
    Colors from PALETTE, dimensions from UI_INPUTS, font from theme.
    """
    p = palette
    ui = UI_INPUTS
    ...
    # Panel on bg_elevated: omit Checkbutton.focus wrapper or clam draws a dashed ring
    # around the label (Checkbutton.focus: focuscolor / focusthickness).
    bg_e = p["bg_elevated"]
    style.configure(
    ...
    # ----- TEntry (flat layout, no thick inner border) -----
    _entry_flat_layout = [
        (
            "Entry.border",
            {
    ...
    # Remove white system focus highlight on Windows (drawn above ttk)
