"""
Пакет layout: каркас слотов приложения.

Контракт пакета (App slots для GUILayout):
...
Блоки разметки экранов (SettingsBlock, grid_section_banner, grid_sub_block) — в template/components.
"""
