"""Image extract provider: convert to JPG with a max dimension limit."""
...
class ImageExtractProvider(FileExtractProvider):
    """Extract raster formats: normalize to JPG with a max dimension limit."""
        ...
        return (
            SettingFieldSchema(
                ...
                options=(
                    ...
                    (IMAGE_ALGORITHM_PROCESS, IMAGE_ALGORITHM_PROCESS),
                ),
            ),
            SettingFieldSchema(
                key="max_size",
